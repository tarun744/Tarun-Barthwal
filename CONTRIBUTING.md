...
**1.**  Fork [this](https://github.com/tarun744/Tarun-Barthwal.git) repository.

**2.**  Clone your forked cop
y of the project.
...
```
 ...
 remote add upstream https://github.com/tarun744/Tarun-Barthwal.git 
```
